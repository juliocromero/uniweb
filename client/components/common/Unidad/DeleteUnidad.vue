    ...
    <v-dialog v-model="dialog" max-width="500px">
      <v-card>
        ...
        <v-card-subtitle class="mt-5 Subtitle 1">
            <strong><h3>¿Está seguro de que desea eliminar esta Unidad.?</h3></strong>
        </v-card-subtitle>
        ...
        <v-card-actions>
          ...
          <v-btn color="blue darken-1" text @click="DeleteUnidad">
            OK
          </v-btn>
        </v-card-actions>
      </v-card>
